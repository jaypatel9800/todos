    ...
    <div className={darkTheme ? "dark" : "light"}>
      <section>
        ...
        <div className="bottom">
          ...
          <button onClick={danger} style={{ cursor: "pointer" }}>
            Clear Completed
          </button>
        </div>
      </section>
      <div className="names">
      <h3 className="lowerName">Challenged by <a href="https://www.frontendmentor.io/" target="_blank" rel="noopener noreferrer">Frontendmentor</a>  |  Completed by <a href="https://jaypatel.cf/" target="_blank" rel="noopener noreferrer">Jay Patel</a></h3>
      </div>
    </div>
  );
};
